...
export const setupFastify = async () => {
  ...
  // Register plugins manually to avoid loading adyen plugin
  await server.register(import('./plugins/operation.plugin.js'));
  await server.register(import('./plugins/novalnet-payment.plugin.js'));
